<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MainNavigation.ascx.cs" Inherits="Ecommerce.Profile.User_Control_FIle.MainNavigation" %>
...
<div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
            ...
            <li runat="server" id="AboutActive"><a href="../About.aspx"><i class="fas fa-info"></i>&nbsp;About Us</a></li>

        </ul>
        <ul class="nav navbar-nav navbar-right">
            <% if (Session["userLoggedin"] != null)
                {%>
            <li class="dropdown profile active">
            ...
            <%} %>
            <li runat="server" id="CartActive"><a href="../ShoppingCart.aspx"><i class="fas fa-shopping-cart"></i><span><%= displayTotalProductsFromCart.Count %></span></a></li>
        </ul>
    </div>
    <!-- /.navbar-collapse -->
</div>
